...
CREATE TABLE public.applicant_video_progress (
  ...
  CONSTRAINT applicant_video_progress_pkey PRIMARY KEY (progress_id),
  CONSTRAINT applicant_video_progress_applicant_id_fkey FOREIGN KEY (applicant_id) REFERENCES public.applicant_profile(applicant_id),
  CONSTRAINT applicant_video_progress_video_id_fkey FOREIGN KEY (video_id) REFERENCES public.onboarding_training_videos(video_id)
);
...
CREATE TABLE public.instances (
  ...
  CONSTRAINT instances_company_id_fkey FOREIGN KEY (company_id) REFERENCES public.company(company_id)
);
...
CREATE TABLE public.onboarding_training_videos (
  ...
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  updated_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT onboarding_training_videos_pkey PRIMARY KEY (video_id),
  CONSTRAINT onboarding_training_videos_company_id_fkey FOREIGN KEY (company_id) REFERENCES public.company(company_id),
  CONSTRAINT onboarding_training_videos_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.user_profile(user_id)
);
