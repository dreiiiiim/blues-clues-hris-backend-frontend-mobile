...
export function TaskChecklist({ tasks, onUpdateTasks }: TaskChecklistProps) {
  ...
  const handleSubmitTaskFromModal = () => {
  ...
  const handleCompleteTask = (checked: boolean) => {
    if (selectedTask) {
      handleCheckTask(selectedTask.id, checked);
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {selectedTask.content.text && (
                    <div className="space-y-2">
                      <ScrollArea 
                        className="h-[400px] w-full border rounded-lg p-4 bg-white" 
              ...
              {selectedTask.status === "for-review" && (
                <div className="bg-orange-50 p-4 rounded-lg flex items-center gap-3 border-2 border-orange-200">
                  <Clock className="size-5 text-orange-600 flex-shrink-0" />
                  <div>
