...
export function OnboardingProcess({
  ...
  // Training videos are always unlocked — applicants can watch them in parallel
  const steps = [
    ...
    { value: "training",  label: "Training",   icon: Video,        unlocked: true,              approved: false },
  ] as const;
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <Tabs defaultValue="profile" className="w-full">
          ...
          <div className="p-5">
            ...
            <TabsContent value="training" className="mt-0 px-6 py-5">
